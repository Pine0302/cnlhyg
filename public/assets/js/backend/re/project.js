define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 're/project/index',
                    add_url: 're/project/add',
                    edit_url: 're/project/edit',
                    pass_url:'re/project/pass',
                    deny_url:'re/project/deny',
                    online_url:'re/project/online',
                    offline_url:'re/project/offline',
                    detail_url:'re/project/detail',
                    del_url: 're/project/del',
                    multi_url: 're/project/multi',
                    table: 're_project',
                }
            });
