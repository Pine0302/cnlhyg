...
class Auth extends \fast\Auth
{
     ...
     * @return array
     */
    public function getLightChildrenAdminIds($withself = false)
    {
        $childrenAdminIds = [];
...
/*
     ...
     * @return array
     */
    public function getLightChildrenAdminInfos($withself = false)
    {
        $childrenAdminIds = [];

        $admin_list = Db::table('admin')
            ->field('id,admin_id,nickname')
            ->select();
        $admin_ids = [];
        if (!$this->isSuperAdmin()) {
            foreach($admin_list as $ka=>$va){
     ...
     * @return array
     */
    public function getNowAdminId($withself = false)
    {
        $childrenAdminIds[] = $this->id;
      /*  $childrenAdminIds = [];
        if (!$this->isSuperAdmin()) {
