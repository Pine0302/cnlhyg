        ...
        if(!empty($sess_key)){
            try{
              ...
              //  $jobQuery->where('j.is_bonus','=',$is_bonus);
                ...
                if($is_hot){
                    $jobQuery->where('j.is_hot','=',$is_hot);
                }
                ...
                if($count>0){
                    ...
                    foreach($work_arr as $kw=>$vw){
                        ...
                        if(!empty($vw['job_experience'])){
                            if(isset( config('webset.job_experience')[$vw['job_experience']])){
            ...
            try {
                ...
                if($type==1){
                    $arr = [
                        ...
                        'brief_content'=>$from_user_info['nickname']."给您推荐了一个岗位...",
                        'content'=>$from_user_info['nickname']."给您推荐了一个岗位...",
                        're_job_id'=>$re_job_id,
                        'create_at'=>date("Y-m-d H:i:s"),
                        'update_at'=>date("Y-m-d H:i:s"),
                        'is_read'=>2,
                    ...
                    $arr = [
                        ...
                        'to_user_id'=>$to_user_id,
                        'from_user_type'=>$user_type,
                        'brief_content'=>$from_user_info['nickname']."给您推荐了一个项目...",
                        'content'=>$from_user_info['nickname']."给您推荐了一个项目...",
