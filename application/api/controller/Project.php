    ...
    public function projectList()
    {
        ...
        if (!empty($sess_key)) {
            try {
                ...
                if (!empty($city_code)) {
                    $city_code = $this->mapCode($city_code);
                }
                ...
                $jobQuery->group('j.id');
                $jobQuery->field('j.id,ac.id as acid,ac.hour_status,j.name,j.sign_num,j.salary_type,j.day_salary_max,j.day_salary_min,j.day_salary,j.project_label,
                ...
                if ($count > 0) {
                    ...
                    $work_info = [];
                       ...
                       // $work_info['job_label3'] = !empty($vw['nature']) ? (config('webset.nature')[$vw['nature']]) : '应届毕业生';
                        $work_info['job_label3'] = !empty($vw['nature']) ? [$vw['nature']] : '无限制';
    ...
    public function projectDetail()
    {
        ...
        if ((!empty($sess_key)) && (!empty($id))) {
            try {
                ...
                $need_type = "未知";
                if (isset($work_detail['need_type'])) {
